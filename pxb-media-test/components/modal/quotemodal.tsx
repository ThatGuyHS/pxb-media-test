        ...
        >
            ...
            <form>
                ...
                <div className="mb-4">
                    ...
                    <textarea placeholder='Describe the service you are looking for. For example: I am hosting a LAN and I want to rent PCs and Screens, or I want a website built' id="description" rows={4} className="w-full p-2 rounded-md bg-gray-700 text-white"></textarea>
                </div>
