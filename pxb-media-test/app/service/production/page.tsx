    ...
    <div className="bg-black text-white font-custom">
      ...
      <div className="w-full px-4 pt-16">
        ...
        <div className="w-full py-20 bg-element text-white">
          <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start text-center md:text-left px-6 md:px-4">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
              <h3 className="text-3xl font-semibold mb-6">Multi-Camera Production</h3>
              ...
              {featuresData.map((feature, index) => {
                ...
                return (
                  <div key={index} className="p-8 bg-element rounded-lg shadow-md">
                    ...
                    <p className="text-base font-semibold mb-3">Key Points of {feature.title}:</p>
        ...
        <div className="w-full py-16 bg-element text-white">
          <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start text-center md:text-left px-6 md:px-4">
            ...
            <div className="md:w-1/2 md:pl-8">
              <h3 className="text-3xl font-semibold mb-6">Live Streaming Services</h3>
              <p className="text-base mb-6">
        ...
        <div className="w-full py-16 bg-element text-white">
          <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start text-center md:text-left px-4 md:px-0">
            <div className="md:w-1/2 mb-8 md:mb-0 md:pr-12">
              <h3 className="text-3xl font-semibold mb-6">Custom Graphics and Overlays</h3>
              <p className="text-base mb-6">
